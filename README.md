...
| **6B.2** | Discovery breadth scanner + control plane | Broad-universe scanner (Alpaca screener / CoinGecko / Kraken listings) → crypto-primary; auto-add with cap + TTL/cooldown; liquidity admission floor + ADV-% size cap |
